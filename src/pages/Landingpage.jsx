...
function Landingpage() {
	...
	const onSubmit = async (data) => {
		...
		localStorage.setItem(
			"guestNumber",
			Number(adultNumber) + Number(childrenNumber)
		);
	...
	useEffect(() => {
		if (
			...
			"https://peachpuff-alligator-715719.hostingersite.com/demiren/api/"
		) {
			localStorage.setItem(
				"url",
				"https://peachpuff-alligator-715719.hostingersite.com/demiren/api/"
		...
		<>
			<div className="flex flex-col min-h-screen ">
				...
				<main className="flex-1 bg-white flex flex-col min-h-screen ">
					...
					<section
						id="home"
						className="relative p-4 md:p-6 min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-hidden"
						style={{
							backgroundImage:
								"linear-gradient(135deg, rgba(30, 58, 138, 0.9) 0%, rgba(67, 56, 202, 0.8) 50%, rgba(29, 78, 216, 0.9) 100%), url('/assets/images/dems1.png')",
					...
					>
						...
						<div className="absolute inset-0 overflow-hidden z-5">
							...
							<div
								className="absolute top-40 right-20 w-48 h-48 bg-gradient-to-br from-indigo-400/15 to-blue-500/15 rounded-full blur-2xl animate-pulse"
								style={{ animationDelay: "1s" }}
							></div>
							<div
								className="absolute bottom-32 left-1/4 w-24 h-24 bg-gradient-to-br from-blue-300/25 to-indigo-400/25 rounded-full blur-lg animate-pulse"
							...
							<div className="text-left w-full animate-fadeIn">
								...
								<div className="max-w-4xl">
									<p className="text-xl md:text-2xl lg:text-3xl font-light leading-relaxed animate-fadeIn animation-delay-300 text-blue-50 drop-shadow-lg">
										Experience comfort, convenience, and genuine hospitality
										where your stay feels like home,
									</p>
									...
									<CardContent className="p-8 relative z-10">
										<div className="mb-6">
											...
											<p className="text-gray-600 text-lg">
												Book your dream accommodation with us
											</p>
										</div>
											...
											<form onSubmit={form.handleSubmit(onSubmit)}>
												<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
													...
													<div
														...
														style={{ animationDelay: "200ms" }}
													>
														<Label className="text-blue-800 font-semibold text-base mb-3 block">
															Adults
														</Label>
					...
					<section
						id="about"
						className="py-20 px-6 rounded overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-indigo-50/50"
					>
						<div className="max-w-7xl mx-auto">
							<div className="text-center mb-16 animate-fadeIn mt-14">
								<h2 className="text-6xl font-playfair mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-800 via-indigo-700 to-blue-900 drop-shadow-sm">
									ABOUT US
								</h2>
								...
								<p className="text-lg text-gray-600 mt-6 max-w-2xl mx-auto">
									Discover the story behind our commitment to exceptional
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
								{/* Left Column */}
								<div
									className="flex flex-col space-y-8 animate-slideInLeft"
									style={{ animationDelay: "100ms" }}
								>
									...
									<div className="relative rounded-3xl overflow-hidden shadow-2xl group h-[60vh] transform transition-all duration-700 hover:scale-[1.02] hover:shadow-3xl">
										...
										<div className="absolute bottom-0 left-0 p-8 z-20 w-full">
											<h3 className="text-3xl font-playfair text-white mb-2 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500 drop-shadow-lg">
												Luxury & Comfort
											</h3>
											<p className="text-blue-100 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 opacity-0 group-hover:opacity-100 drop-shadow-md">
												Experience the perfect blend of elegance and comfort
											</p>
										</div>
									...
									<div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50/50 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-blue-100/50 group relative overflow-hidden">
										...
										<div className="relative z-10">
											<div className="flex items-center mb-4">
												...
												<h3 className="text-2xl font-semibold bg-gradient-to-r from-blue-800 to-indigo-800 bg-clip-text text-transparent">
													Our Promise
												</h3>
											</div>
											<p className="text-lg text-gray-700 leading-relaxed mb-4">
												At Demiren, we don't just offer a place to stay — we
												provide a space to relax, dine, and feel genuinely cared
												for. Our in-house restaurant serves a selection of local
												and international dishes, prepared with passion and
												fresh ingredients to satisfy every appetite.
											</p>
											<p className="text-lg text-gray-700 leading-relaxed">
												From the moment you arrive to the time you leave, we aim
												to make your stay smooth, restful, and enjoyable.
											</p>
								...
								{/* Right Column */}
								<div
									className="flex flex-col space-y-8 animate-slideInRight"
									style={{ animationDelay: "200ms" }}
								>
									{/* Enhanced Text block */}
									<div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 p-8 rounded-3xl shadow-xl text-white transform hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
										...
										<div className="relative z-10">
											...
											<p className="text-lg leading-relaxed text-blue-50 mb-4">
												Welcome to Demiren Hotel & your trusted home away from
												home. Nestled in a convenient location, we combine
												modern comfort with warm, personalized hospitality to
												give every guest a memorable experience.
											</p>
											<p className="text-lg leading-relaxed text-blue-100">
												Whether you're staying for business, leisure, or a
												family getaway, our well-appointed rooms, exceptional
												service, and inviting atmosphere are designed to meet
												your every need.
											</p>
						...
						<div className="max-w-7xl mx-auto">
							<div className="text-center mb-16 animate-fadeIn">
								...
								<p className="text-lg text-gray-600 mt-6 max-w-3xl mx-auto">
									Discover elegant spaces crafted for relaxation, style, and a
									restful night's sleep. Each room is thoughtfully designed to
										...
										.map((room, index) => (
											...
											>
													...
													<div className="absolute bottom-0 left-0 right-0 p-6 z-20 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
														<div className="bg-gradient-to-t from-blue-900/95 to-blue-800/80 backdrop-blur-sm rounded-2xl p-4 border border-blue-400/30">
															...
															<div className="flex flex-wrap gap-2">
																<span className="px-3 py-1 bg-white/20 rounded-full text-blue-100 text-sm">
																	🛏️ {room.room_beds} Bed
																	{room.room_beds > 1 ? "s" : ""}
																</span>
																<span className="px-3 py-1 bg-white/20 rounded-full text-blue-100 text-sm">
												...
												<div className="flex flex-col p-6 flex-1 relative z-10">
													...
													<div className="mb-6">
														<h6 className="text-sm font-semibold text-blue-700 mb-3 uppercase tracking-wide">
															Room Features
														</h6>
														<div className="grid grid-cols-3 gap-3">
															...
															<div className="text-center p-3 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100/50 group-hover:shadow-md transition-all duration-300">
																...
																<span className="text-xs text-indigo-700 font-medium">
																	{room.room_capacity} Guest
																	{room.room_capacity > 1 ? "s" : ""}
																</span>
															</div>
															<div className="text-center p-3 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100/50 group-hover:shadow-md transition-all duration-300">
																<svg
					...
					<section
						id="contact"
						className="py-20 px-6 rounded overflow-hidden bg-gradient-to-b from-white to-blue-50"
					>
						<div className="max-w-7xl mx-auto">
							<div className="text-center mb-16 animate-fadeIn mt-14">
								<h2 className="text-6xl font-playfair mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-indigo-800">
									CONTACT US
								</h2>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
								...
								>
									<div className="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-blue-100">
										<h3 className="text-3xl font-playfair mb-6 text-blue-800">
											Have Questions?
										</h3>
										<h4 className="text-2xl font-playfair mb-8 text-indigo-700">
											We've Got Answers!
										</h4>
														...
														<FormItem className="group">
															...
															<FormControl>
																<div className="relative">
																	...
																	/>
																	<User
																		className="absolute left-3 top-1/2 -translate-y-1/2 text-blue-400 group-focus-within:text-blue-600 transition-colors duration-300"
																		size={18}
																	/>
																</div>
															</FormControl>
														...
														<FormItem className="group">
															...
															<FormControl>
																<div className="relative">
																	...
																	<svg
																		xmlns="http://www.w3.org/2000/svg"
																		className="absolute left-3 top-8 text-blue-400 group-focus-within:text-blue-600 transition-colors duration-300"
																		width="18"
																		height="18"
																		viewBox="0 0 24 24"
																		fill="none"
								...
								>
									<div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-3xl shadow-lg text-white transform hover:shadow-xl transition-all duration-300">
										...
										<p className="text-lg leading-relaxed">
											Find everything you need to know about your stay at
											Demiren Hotel & Restaurant. From check-in details to
											exclusive experiences, we've covered it all!
										</p>
									...
									<div className="relative rounded-3xl overflow-hidden shadow-2xl group h-[50vh] transform transition-transform duration-700 hover:scale-[1.02]">
										...
										/>
										<div className="absolute bottom-0 left-0 p-8 z-20 w-full">
											<h3 className="text-3xl font-playfair text-white mb-2 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
												Visit Us Today
											</h3>
											<p className="text-white/90 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 opacity-0 group-hover:opacity-100">
												Experience our exceptional hospitality in person
											</p>
										</div>
									</div>
								</div>
