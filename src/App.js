					...
					<WalkInProvider>
						<ApprovalProvider>
							<Routes>
								...
								/>
								<Route
									path="/admin/bookingroomselection"
									element={
										<AdminRouteGuard>
								...
								/>
								<Route
									path="/frontdesk/booking-list"
									element={<FrontdeskBookingList />}
								/>
								<Route
									path="/frontdesk/transaction-history"
									element={<FrontdeskTransactionHis />}
								/>
								<Route
									path="/frontdesk/reservations"
									element={<FrontdeskReservation />}
								/>

								{/* Legacy Frontdesk Routes */}
								<Route
									path="/BookingChargesMaster"
									element={<BookingChargesMaster />}
								/>
								<Route
								...
								<Route
									...
									element={<BookingChargesList />}
								/>
								<Route
									path="/BookingCreateInvoice"
									element={<BookingCreateInvoice />}
								/>
								<Route
									path="/BookingDisplayInvoiceSample"
									element={<BookingDisplayInvoiceSample />}
								/>
								...
								<Route
									...
									element={<CustomerRestaurant />}
								/>
								<Route path="/customer/roomsearch" element={<RoomSearch />} />
								<Route
									path="/customer/roomview"
									element={<CustomerRoomView />}
								/>
